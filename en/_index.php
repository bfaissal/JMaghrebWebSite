				...
				<section class="slice noPaddingBottom" id="about">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<h1>About us</h1>
								<h2 class="subTitle">Let's move JAVA forward</h2>
							</div>
						</div>
					...
					<div class="container clearfix">
						<div class="row">
							...
							<div class="portfolio-items row isotopeWrapper clearfix imgHover" id="3">
								<article class="col-sm-3 isotopeItem team rev speaker">
								...
								<article class="col-sm-3 isotopeItem team rev">
									<section class="imgWrapper_"> 
                                ...
                                <article class="col-sm-3 isotopeItem team">
                                    ...
                                    <?php
                                        $unparsed_json = file_get_contents("http://cfp.jmaghreb.io/acceptedSpeakers");
                                        $json_object = json_decode($unparsed_json,true);
                                        //print_r($json_object['speakers']);
                                        foreach($json_object['speakers'] as $speaker){
                                        ?>
                                    <article class="col-sm-3 isotopeItem speaker">
									<section class="imgWrapper_"> 
										<img alt="" src="<?php echo $speaker['image'] ?>" class="img-responsive"> 
									</section>
									<div class="mediaHover">
										<div class="mask"></div>
										<div class="iconLinks">
										...
										<section class="boxContent" style="text-align:center;background-color:#F7F7F7;padding: 5px;margin-top:0px;">
                                            ...
                                            <ul class="socialNetwork ">
                                                ...
                                                <li>
                                                    <a href="https://twitter.com/<?php echo $speaker['twitter']?>" title="link" class="tips" target="twit">
                                                        <i class="icon-twitter-bird iconRounded "></i>
                                                    </a>
                                                </li>
								        </ul>
