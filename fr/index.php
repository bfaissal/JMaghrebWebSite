						...
						<div class="navbar-header">
							...
							<div class="collapse navbar-collapse navbar-ex1-collapse" id="scrollTarget">
								<ul class="nav navbar-nav pull-right">
									...
									<li><a href="#services"><i class="icon-thumbs-up"></i>Programme</a> </li>
									<li><a href="#works"><i class="icon-popup-1"></i>JMaghrebiens</a> </li>
						...
						<div class="row">
							...
							<nav id="filter" class="col-md-12 text-center">
								<ul>
                                    ...
                                    <li><a href=""  class="btn btn-sm" data-filter=".speaker">Conférenciers</a></li>
								</ul>
							</nav>
