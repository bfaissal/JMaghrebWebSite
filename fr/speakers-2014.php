...
<head>
	...
	<body data-spy="scroll" data-target="#scrollTarget" data-offset="150" iclass="activateAppearAnimation">
		...
		<div id="preloader">
			<div id="status">
				<img src="images/theme-pics/loader.gif?v_res_jmeagh=0.1" alt=""/><h1 class="noSubtitle">Les conférencier de JMaghreb 3.0</h1>
			</div>
		</div>
		<!-- Preloader -->
		<!-- Primary Page Layout 
						...
						<div class="navbar-header">
							...
							<div class="collapse navbar-collapse navbar-ex1-collapse" id="scrollTarget">
								<ul class="nav navbar-nav pull-right">
									...
									<li><a href="index.php#about"><i class="icon-star"></i>À propos</a> </li>
									<li><a href="index.php#program"><i class="icon-thumbs-up"></i>Programme</a> </li>
									<li><a href="index.php#team"><i class="icon-popup-1"></i>JMaghrebiens</a> </li>
									<li><a href="#speakers"><i class="icon-mic-outline"></i>Conférenciers</a> </li>
									<li><a href="index.php#sponsors"><i class="icon-users"></i>Sponsors</a> </li>
									<li><a href="index.php#contactSlice"><i class="icon-mail"></i>Contact</a> </li>
				...
				<section class="slice" id="speakers">
					<div class="container clearfix">
						<div class="row">
							<div class="col-sm-12">
								<h1>JMaghreb3.0</h1>
								<h2 class="subTitle">Liste des conférenciers</h2>
							</div>
