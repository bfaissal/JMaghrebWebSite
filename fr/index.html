...
<head>
		...
		<meta name="description" content="Site web de JMaghreb 2014">
	...
	<body data-spy="scroll" data-target="#scrollTarget" data-offset="150" id="fullScreen">
		...
		<div id="preloader">
			<div id="status">
				<img src="images/theme-pics/loader.gif?v_res_jmeagh=0.1" alt=""/><h1 class="noSubtitle">Bienvenue</h1>
			</div>
		</div>
		<!-- Preloader -->
		<!-- Primary Page Layout 
						...
						<div class="navbar-header">
							...
							<div class="collapse navbar-collapse navbar-ex1-collapse" id="scrollTarget">
								<ul class="nav navbar-nav pull-right">
									...
									<li><a href="#about"><i class="icon-star"></i>À propos</a> </li>
									<li><a href="#program"><i class="icon-thumbs-up"></i>Programme</a> </li>
									<li><a href="#team"><i class="icon-popup-1"></i>JMaghrebiens</a> </li>
									<li><a href="#sponsors"><i class="icon-users"></i>Sponsors</a> </li>
									<li><a href="#contactSlice"><i class="icon-mail"></i>Contact</a> </li>
                                    <li><a href="../en"><i class="icon-arrows-cw-outline"></i>English</a> </li>
								</ul>
							</div>
					...
					<div class="maskParent" >
						...
						<div id="fullScreenSliderWrapper">
							...
							<div class="flexslider" id="flexHome">
								<ul class="slides">
									<li>
										<h1>La confrence du développeur PRAGMATIQUE</h1>							
									</li>
									<li>
							...
							<a href="#about" class="homeBtn btn"><i class="icon-down"></i>Apprenez-en plus</a>
						</div>
					</div>
				</section>
				<!-- about us -->
					...
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								...
								<h2 class="subTitle">La confrence du développeur PRAGMATIQUE</h2>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-sm-12">
								...
								<p>Organisée par l’équipe Morocco JUG depuis 2012, JMaghreb est considérée comme la plus grande manifestation en Afrique autour de l’écosystème Java, langages JVM, Web , HTML5, Mobile, Cloud, Big Data…
								</p>
                                <p>
                                Durant 3 jours la conférence propose, en parallèle, des présentations et ateliers pratiques en anglais et français animés par des experts de renommer internationale. JMaghreb est l’occasion de rencontrer les créateurs de projets open source innovants, de s’y impliquer, de partager, de s’améliorer … dans une ambiance cool et décontractée :- )
                                </p>
							</div>
  ...
  frameborder="0"></iframe>
				...
				<section class="slice color4" id="program">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<h1>Programme</h1>
								<h2 class="subTitle">JMaghreb couvre une varieté de technologies de pointe</h2>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-3 col-sm-6">
								<article class="boxFeature-2">
									...
									<h2>Methodologie, Agile & DevOps</h2>
                        ...
                        <div class="row" style="text-align:center;margin-top:10px;">
                            ...
                            <a href="http://cfp.jmaghreb.io/" target="_blank" class="btn">Soumettre une proposition à JMaghreb</a>
                                </div>
                        </div>
					</div>
				</section>
				...
				<div id="paralaxSlice5" data-stellar-background-ratio="0.5">
					<div class="maskParent">
						...
						<div class="paralaxText container">
							<blockquote class="bigTitle">Un événement axé sur la communauté</blockquote>
						</div>
					</div>
				</div>
				...
				<section class="slice" id="team">
					<div class="container clearfix">
						<div class="row">
							<div class="col-sm-12">
								<h1>JMaghrebiens</h1>
								<h2 class="subTitle">L'équipe derrière JMaghreb</h2>
							</div>
							<nav id="filter" class="col-md-12 text-center">
								<ul>
									<li><a href="" class="current btn btn-sm" data-filter="*">Tous</a></li>
									<li><a href=""  class="btn btn-sm" data-filter=".team" >L'équipe</a></li>
									<li ><a href="" class="btn btn-sm" data-filter=".rev">Evaluateurs</a></li>
								</ul>
							</nav>
					...
					<div id="paralaxSlice1" data-stellar-background-ratio="0.5">
						<div class="maskParent">
							...
							<div class="paralaxText">
								...
								<blockquote class="mt15">On ne pouvait pas espérer un tel évènement sans leur implication</blockquote>
							</div>
						</div>
					</div>
					<section class="slice" id="sponsors">
						<div class="container">
							<div class="row">
								<div class="col-xs-12">
									<h1>Nos Sponsors</h1>
									<h2 class="subTitle">Merci à nos partenaires</h2>
								</div>
						...
						<div class="col-xs-12">
									...
									<h2 class="subTitle"> <a href= "./partners-friends.html">Découvrez nos partenaires</a></h2>
								</div>
							</div>
					</section>
					...
					<div id="paralaxSlice4" data-stellar-background-ratio="0.5" >
						<div class="maskParent">
							...
							<div class="paralaxText">
								<blockquote>Contactez nous</blockquote>
					...
					<section class="slice"  id="contactSlice" >
						<div class="container">
							<div class="row">
								...
								<div class="col-sm-12">
									<h1 class="noSubtitle">Contactez nous</h1>
								</div>
								
								<div class="col-sm-12">
									
									<address>
										Pour toute question ou partenariat, vous pouvez contacter l'équipe de JMaghreb à: <a href="mailto:info@jmaghreb.io">info@jmaghreb.io</a>
									</address>
						...
						<div class="container">
							<div class="row">
								<div class="col-sm-12 text-center">
									<p>Copyright © 2014 <a href="http://www.jmaghreb.io" target="blank">JMaghreb</a> / Tous droits réservés.</p>
								</div>
		...
		<!-- Custom  -->
		<script type="text/javascript" src="js/custom.js?v_jmeagh=0.3"></script>
        <script>
